...
{
    /* Paranoia.  not necessary, I'm using it somewhere else
  ...
  if ($("div#fragcolors_app").length > 0)
  {
    ...
    /* Install the app.  */
    $("div#fragcolors_app").html("<h2>Text Comparison</h2>"
    + "<p id='fragcolors_myinput'>"
    + "<span style='padding-left: 10px;'>Minimum run length </span>"
    + "<span style='padding-left: 10px;'><input type='input' id='fragcolors_minrunlen' value='4' size='4'/></span>"
    + "<span style='padding-left: 10px;'><input type='button' id='fragcolors_settext' value='Compare texts'</button></span>"  
      + "<span style='padding-left: 10px;'>Text that is identical on each side is marked in the same color</span>"
      + "</p>"
      + "<div id='fragcolors_maintext' style='width: 100%'>"
      + "<div id='fragcolors_column1' style='float:left; width:47%'>"
      + "<textarea id='fragcolors_text1' style='width: 95%; height: 250px;'>...</textarea>"
      + "<div id='fragcolors_main1' style='white-space: pre-wrap'>"
    + "<p>Copy the first text of the pair to be compared here</p></div>"
      + "</div>"
      + "<div id='fragcolors_column2' style='float:right; width:47%'>"
      + "<textarea id='fragcolors_text2' style='width: 95%; height: 250px;'>...</textarea>"
      + "<div id='fragcolors_main2' style='white-space: pre-wrap'>"
    + "<p>Copy the second text of the pair to be compared here</p></div>"
      + "</div>"
      + "</div>"
    + "<div id='copyright' style='clear:both; float:left'>"
    + "<small> &nbsp;</small><br/>"
    + "<small>Translated version of <a href='http://de.vroniplag.wikia.com/wiki/Quelle:Textvergleich'>"
    + "http://de.vroniplag.wikia.com/wiki/Quelle:Textvergleich</a> <br/>"
    + "Copyright by Marcusb @ Vroniplag Wiki. Licensed under GNU General Public License v3 or later.</br>"
    + "Based on the sim_text algorithm of Dick Grune and Matty Huntjens. </small>"
    + "</div>"
    );
...
/* Monkey-patching FTW!  See renderPreview function in:
   http://images.wikia.nocookie.net/common/__cb49614/extensions/wikia/EditPageLayout/js/plugins/PageControls.js
